...
<body>
  ...
  <header class="header-area header-sticky">
   ...
   <section id="section-1">
    ...
    <div id="login-bo">
      <div class="estudiant"><a href="/iniciar_sesion"><i class="fa fa-user"></i> Estudiante</a></div>
    </div>

    <div class="main-caption">
      
        <div class="empres"><a href="/iniciar_sesion"><i class="fa fa-user"></i> Empresa</a></div>
      </div>
