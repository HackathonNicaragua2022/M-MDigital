<div>
    ...
    <form wire:submit.prevent="store" class="grid gap-3">
        ...
        <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
            ...
            <div class="relative">
                <!-- User Avatar -->
                <img class="w-20 h-20 rounded-md object-cover" src="{{ Auth::user()->profile_photo_url }}"
                    alt="{{ Auth::user()->name }}" />
            ...
            <div class="flex flex-col px-6">
                ...
                <div class="my-2 flex flex-row space-x-2">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ Auth::user()->username }}</div>
                    </div>
          ...
          <div class="text-xs text-gray-400/80 hover:text-gray-400">Istanbul</div>
                    ...
                    <div class="flex h-8 flex-row">
                        <div class="flex flex-row">
                            ...
                            <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ Auth::user()->email }}</div>
                        </div>
                    </div>
                        </div>
                    </div>
        ...
        @if ($coverImage)
            <img class=" mt-3 mb-4 w-60 h-60 rounded-md object-cover" src="{{ $coverImage->temporaryUrl() }}">
        @endif
    ...
    <label for="></label>
            <textarea wire:model="body" id=""
                class=" mt-3 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
