...
<body>
  ...
  <header class="header-area header-sticky">
   ...
   <section id="section-1">
    ...
    <div id="login-bo">
      <div class="estudiant"><a href="/estudiante"><i class="fa fa-user"></i> Usuario Estudiante</a></div>
    </div>

    <div class="main-caption">
      
        <div class="empres"><a href="/Empresa"><i class="fa fa-user"></i> Usuario Empresa</a></div>
      </div>
