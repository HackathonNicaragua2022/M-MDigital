            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="/oferta" class="active">Ofertas</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <p>Conoce las ofertas laborales del día a día y elige la que mejor se acople a tu perfil, contacta y comunícate directamente con las empresas.</p>
